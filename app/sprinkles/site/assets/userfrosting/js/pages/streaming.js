						...
						janus.attach(
							{
								...
								onremotestream: function(stream) {
									...
									if($('#remotevideo').length === 0) {
										addButtons = true;
										$('#stream').append('<video class="rounded centered hide" id="remotevideo" width="100%" height="100%" autoplay controls/>');
										// Show the stream and hide the spinner when we get a playing event
										$("#remotevideo").get(0).onplaying=function(){
											console.log("playing video test sh");
										}
										...
										//$("#remotevideo").get(0).trigger('playing');
									}
